...
public interface ResponsesApi {
    ...
    @RequestMapping(value = "/responses/{assignmentId}/{questionId}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<Response>> getQuestionResponse(@ApiParam(value = "",required=true) @PathVariable("assignmentId") Long assignmentId,@ApiParam(value = "",required=true) @PathVariable("questionId") Long questionId);
